...
class PlaylistController {
    ...
    //You can call PlaylistController.shared.load in your ViewDid'load or AppDelegate and it will still load. This is better befcausse it will load the very first time the shared instance is called. It matches your Source OfTruth to the info that is loading out of the local disc from your iphone 
    init() {
        self.playlists = load()
    }
